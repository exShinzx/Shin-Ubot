...
@Shin_cmd(pattern=r"^ping$", incoming=True, from_users=DEVLIST)
async def _(ping):
...
async def _(pong):
    ...
    await kping.edit("**SEMUANYA MINGGIR Shin MAU LEWAT.....**")
    end = datetime.now()
    duration = (end - start).microseconds / 1000
    await kping.edit("😎")
    sleep(3)
