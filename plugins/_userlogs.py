...
from Shin.dB.botchat_db import tag_add, who_tag
...
if udB.get_key("TAG_LOG"):
    ...
    @Shin_bot.on(events.MessageEdited(func=lambda x: not x.out))
    ...
    async def idk(e):
        ...
        if chat and msg:
            try:
                await Shin_bot.send_message(chat, e.message, reply_to=msg)
...
_client = {"bot": asst, "user": Shin_bot}
