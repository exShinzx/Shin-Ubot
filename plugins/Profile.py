...
from . import eod, eor, get_string, mediainfo, Shin_cmd
...
@Shin_cmd(pattern="setbio( (.*)|$)", fullsudo=True)
async def _(ayra):
    ok = await ayra.eor("...")
...
@Shin_cmd(pattern="setname ?((.|//)*)", fullsudo=True)
async def _(ayra):
    ok = await ayra.eor("...")
...
@Shin_cmd(pattern="setfp$", fullsudo=True)
async def _(ayra):
...
@Shin_cmd(pattern="delfp( (.*)|$)", fullsudo=True)
