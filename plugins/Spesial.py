...
from Shin.fns.google_image import googleimagesdownload
from Shin.fns.tools import metadata
...
@Shin_cmd(pattern="q( (.*)|$)", manager=True, allow_pm=True)
async def quott_(event):
    ...
    message = await reply.reply("Quotly by Shin Ubot", file=file)
    os.remove(file)
    await msg.delete()
    return message
