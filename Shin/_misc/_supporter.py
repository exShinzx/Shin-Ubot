...
from Shin._misc._decorators import compile_pattern, Shin_cmd
...
ALIVE_NAME = Shin_bot.me.first_name
BOTLOG_CHATID = BOTLOG = udB.get_key("LOG_CHANNEL")


bot = borg = catub = friday = Shin_bot
catub.cat_cmd = Shin_cmd
...
class Config((object)):
    if ENV:
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Shin")
