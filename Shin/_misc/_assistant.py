...
from .. import LOGS, asst, udB, Shin_bot
from ..fns.admins import admin_check
from . import append_or_update, owner_and_sudos

OWNER = Shin_bot.full_name

MSG = f"""
**ᴋᴀᴢᴜ ᴜʙᴏᴛ​**
➖➖➖➖➖➖➖➖➖➖
**Owner**: [{OWNER}](tg://user?id={Shin_bot.uid})
**Support**: @shinsupport
➖➖➖➖➖➖➖➖➖➖
"""
...
IN_BTTS = [
    [
        Button.url(
            "Repository",
            url="https://github.com/ionmusic/Shin-Ubot",
        ),
        Button.url("Support", url="https://t.me/Shinsupportgrp"),
    ]
]
...
def callback(data=None, from_users=[], admins=False, owner=False, **kwargs):
    ...
    if "me" in from_users:
        ...
        from_users.append(Shin_bot.uid)
                    ...
                    await event.answer(
                        [
                            await event.builder.article(
                                ...
                                text=error_text(),
                                buttons=Button.url(
                                    "Report", "https://t.me/Shinsupportgrp"
                                ),
                            )
                        ]
                    )
