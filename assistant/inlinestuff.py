...
from Shin.fns.misc import google_search
...
from . import *
from . import _Shin_cache

SUP_BUTTONS = [
    [
        Button.url("• Repo •", url="https://github.com/ionmusic/Shin-Ubot"),
        Button.url("• Support •", url="t.me/Shinsupportgrp"),
    ],
]

ofox = "https://graph.org/file/231f0049fcd722824f13b.jpg"
gugirl = "https://graph.org/file/0df54ae4541abca96aa11.jpg"
Shinpic = "https://graph.org/file/e2f568b76280fadc8ee54.jpg"
...
async def repo(e):
    res = [
        await e.builder.article(
            ...
            thumb=wb(Shinpic, 0, "image/jpeg", []),
            text="**◈ ᴋᴀᴢᴜ ᴜʙᴏᴛ​ ◈**",
            buttons=SUP_BUTTONS,
        ),
    ]
    await e.answer(res, switch_pm="Shin Repo.", switch_pm_param="start")
...
async def twitter_search(event):
    ...
    if _Shin_cache.get("twitter"):
        _Shin_cache["twitter"].update({match: reso})
    else:
        _Shin_cache.update({"twitter": {match: reso}})
        ...
        return await ay.answer(
            [
                await ay.builder.article(
                    title="How to Use?",
                    description="Tl Searcher by Shin",
...
InlinePlugin.update(
    {
        ...
        "Sᴇᴀʀᴄʜ Oɴ Gᴏᴏɢʟᴇ": "go Shinsupportgrp",
        "WʜɪSᴘᴇʀ": "wspr @username Hello🎉",
        "YᴏᴜTᴜʙᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ": "yt Ed Sheeran Perfect",
        "Piston Eval": "run javascript console.log('Hello Shin')",
        "OʀᴀɴɢᴇFᴏx🦊": "ofox beryllium",
        "Tᴡɪᴛᴛᴇʀ Usᴇʀ": "twitter Shinsupportgrp",
